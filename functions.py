import requests # allows is to make API calls
import json # works with texts in a json format
import polars as pl # faster version of pandas
from youtube_transcript_api import YouTubeTranscriptApi # grab the transcripts programatically
